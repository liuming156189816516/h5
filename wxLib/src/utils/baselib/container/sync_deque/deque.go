...
/*
	...
	@returns:
		string: 返回的deque指针
*/
func NewSyncDeque() *SyncDeque {
	return NewCappedSyncDeque(-1)
}
...
/*
	...
	@returns:
		string: 返回的deque指针
*/
func NewCappedSyncDeque(capacity int) *SyncDeque {
	return &SyncDeque{
		container: list.New(),
		capacity:  capacity,
	}
...
*/
func (s *SyncDeque) Append(item interface{}) bool {
	s.Lock()
	defer s.Unlock()
...
/*
	...
	@returns:
		bool: 插入失败（超过deque指定容量），返回false;插入成功，返回true
*/
func (s *SyncDeque) Prepend(item interface{}) bool {
	s.Lock()
	defer s.Unlock()
...
*/
func (s *SyncDeque) Pop() interface{} {
	s.Lock()
	defer s.Unlock()
...
*/
func (s *SyncDeque) Shift() interface{} {
	s.Lock()
	defer s.Unlock()
...
*/
func (s *SyncDeque) First() interface{} {
	s.RLock()
	defer s.RUnlock()
...
*/
func (s *SyncDeque) Last() interface{} {
	s.RLock()
	defer s.RUnlock()

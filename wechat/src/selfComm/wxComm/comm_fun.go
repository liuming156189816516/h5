...
var PlaceMap = map[string]map[string]string{
	"1": {
		"pixid": "263913319790320",
		"token": "CQu8oPRZq1GOaGMdyrE07DnD_bJx8sErXj1GTWF4Q9g",
	},
	"2": {
		"pixid": "264686962789320",
		"token": "29D7QJU0dT7yE9H6TuWp1T237_bUNeEgokt77iS9HgY",
	},
}

// 获取投放Token
func GetPlaceInfo(ch string) map[string]string {
	return PlaceMap[ch]
}

type PlaceRegisterReq struct {
	Type       string `json:"type"`
	Pixid      string `json:"pixid"`
	Token      string `json:"token"`
	Clid       string `json:"clid"`
	Adid       string `json:"adid"`
	Unixtype   string `json:"unixtype"`
	Unixtime   int64  `json:"unixtime"`
	Event      string `json:"event"`
	TestServe  bool   `json:"testServe"`
...
// 投放注册
func PlaceRegister(req *PlaceRegisterReq) *PlaceRegisterRsp {
	api := "https://zsxdonline.com/v6"
	rsp := wxHttp.ZHttp(wxHttp.ZHttpReqParam{
		Url:     api,
		Method:  "post",
		Content: req,

...
var exceptionList = map[string]bool{
	"AdminMemberController-Login":       true,
	"WorkShuntController-Shunt":         true,
	"WorkController-CheckPassword":      true,
	"WorkController-GetWorkAccountList": true,
	"WorkController-GetWorkTask":        true,
}

...
func main() {
	...
	logs.SetLogger(logs.AdapterFile, `{"filename":"./logs/data.log","separate":["debug","error"]}`)
	...
	if err := natsRpc.StartNats(serverName, int32(natsRpc.GetServerId())); err != nil {
